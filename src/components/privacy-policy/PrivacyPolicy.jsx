  ...
  return (
    ...
    <div className="delay">
      ...
      <ul>
        <li>
          <p>
            <h4>Account</h4> means a unique account created for You to
            access our Service or parts of our Service.
          </p>
        </li>
        <li>
          <p>
            <h4>Company</h4> (referred to as either &quot;the
        ...
        <li>
          <p>
            <h4>Cookies</h4> are small files that are placed on Your
        ...
        <li>
          <p>
            <h4>Country</h4> refers to: Romania
          </p>
        </li>
        <li>
          <p>
            <h4>Device</h4> means any device that can access the Service
            such as a computer, a cellphone or a digital tablet.
          </p>
        </li>
        <li>
          <p>
            <h4>Personal Data</h4> is any information that relates to an
            identified or identifiable individual.
          </p>
        </li>
        <li>
          <p>
            <h4>Service</h4> refers to the Website.
          </p>
        </li>
        <li>
          <p>
            <h4>Service Provider</h4> means any natural or legal person
        ...
        <li>
          <p>
            <h4>Usage Data</h4> refers to data collected automatically,
        ...
        <li>
          <p>
            <h4>Website</h4> refers to Home TV, accessible from{" "}
            <a
        ...
        <li>
          <p>
            <h4>You</h4> means the individual accessing or using the
      ...
      <ul>
        <li>
          <h4>Cookies or Browser Cookies.</h4> A cookie is a small file
        ...
        <li>
          <h4>Flash Cookies.</h4> Certain features of our Service may
        ...
        <li>
          <h4>Web Beacons.</h4> Certain sections of our Service and our
      ...
      <ul>
        <li>
          <p>
            <h4>To provide and maintain our Service</h4>including to
            monitor the usage of our Service.
          </p>
        </li>
        <li>
          <p>
            <h4>To manage Your Account:</h4> to manage Your registration
        ...
        <li>
          <p>
            <h4>For the performance of a contract:</h4> the development,
        ...
        <li>
          <p>
            <h4>To contact You:</h4> To contact You by email, telephone
        ...
        <li>
          <p>
            <h4>To provide You</h4> with news, special offers and
        ...
        <li>
          <p>
            <h4>To manage Your requests:</h4> To attend and manage Your
            requests to Us.
          </p>
        </li>
        <li>
          <p>
            <h4>For business transfers:</h4> We may use Your information
        ...
        <li>
          <p>
            <h4>For other purposes</h4>We may use Your information for
      ...
      <ul>
        <li>
          <h4>With Service Providers:</h4> We may share Your personal
          information with Service Providers to monitor and analyze the use of
          our Service, to contact You.
        </li>
        <li>
          <h4>For business transfers:</h4> We may share or transfer Your
        ...
        <li>
          <h4>With Affiliates:</h4> We may share Your information with
        ...
        <li>
          <h4>With business partners:</h4> We may share Your information
          with Our business partners to offer You certain products, services or
          promotions.
        </li>
        <li>
          <h4>With other users:</h4> when You share personal information
          or otherwise interact in the public areas with other users, such
          information may be viewed by all users and may be publicly distributed
          outside.
        </li>
        <li>
          <h4>With Your consent</h4>We may disclose Your personal
      ...
      <p>
        ...
        third party's site. We h4ly advise You to review the Privacy Policy
